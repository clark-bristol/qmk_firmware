...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LSPO,  KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LSPO,
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, CLICKY_TOGGLE,   CK_UP, CK_DOWN, _______,    RESET,   RESET, _______, _______, _______, _______, _______,
    _______,       _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______
)
