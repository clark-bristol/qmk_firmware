...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    _______, _______,  KC_GRAVE, KC_ESC,  KC_LALT, KC_LGUI, TD(CESC), _______,               HYPR_T(KC_SPC), KC_RGUI,  KC_RALT,  KC_RCTL,  _______, KC_BSLS, _______
  ),
  ...
  [_2] = LAYOUT_65_with_macro(
    ...
    _______      ,_______,_______,_______,_______,_______,_______,_______,KC_LEFT,KC_DOWN,KC_UP  ,KC_RGHT,_______,_______,_______,_______,
    ...
    _______      ,_______,_______,_______,_______,_______,_______,_______,LM(_1,MOD_LCTL) ,_______,_______,_______,_______,_______,_______
  ),
