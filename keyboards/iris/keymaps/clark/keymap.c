...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----+----+----+----+----+----+----.    ,----|----+----+----+----+----+----|
     LSFT, Z  , X  , C  , V  , B  ,HYPR,      MEH, N  , M  ,COMM,DOT ,SLSH,RSFT,
  //`----+----+----+--+-+----+----+----/    \----+----+----+----+----+----+----'
...
[_LOWER] = KC_KEYMAP(
  ...
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
         ,    , UP ,    ,    ,    ,                   ,    ,    , UP ,    ,    ,
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
         ,LEFT,DOWN,RGHT,    ,LCBR,               RCBR,    ,LEFT,DOWN,RGHT,    ,
  //|----+----+----+----+----+----+----.    ,----|----+----+----+----+----+----|
         ,EQUAL,UNDS,MINS,LPRN,LBRC,    ,        ,RBRC,RPRN,MINS,UNDS,EQUAL,   ,
  //`----+----+----+--+-+----+----+----/    \----+----+----+----+----+----+----'
                           ,    ,    ,             ,    ,
  //                  `----+----+----'        `----+----+----'
  ),
...
[_RAISE] = KC_KEYMAP(
  ...
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
         ,    ,HOME,    ,    ,    ,                   ,    , P4 , P5 , P6 ,    ,
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
         ,    , END,    ,    ,    ,                   ,PMNS, P1 , P2 , P3 ,PSLS,
  //|----+----+----+----+----+----+----.    ,----|----+----+----+----+----+----|
         ,    ,    ,    ,    ,    ,    ,         ,    ,PPLS, P0 ,PDOT,PENT,PAST,
  //`----+----+----+--+-+----+----+----/    \----+----+----+----+----+----+----'
                           ,    ,    ,             ,    ,
  //                  `----+----+----'        `----+----+----'
  ),
